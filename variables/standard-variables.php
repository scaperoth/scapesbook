...
//footer
$scripts = '<script src="http://code.jquery.com/jquery-1.9.1.min.js"></script>
...
//message to display if just created user and logged in message is set in php_actions/user_actions/create_user.php
    $welcome_message = (isset($_SESSION['Welcome_message']) ? '<h2 class="welcome-message">' . $_SESSION['Welcome_message'] . '!</h2>' : '');
